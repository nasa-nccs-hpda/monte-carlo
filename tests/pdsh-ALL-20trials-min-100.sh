...
/app/jupyter/ilab/tensorflow-kernel/bin/python3.8 /panfs/ccds02/nobackup/people/gtamkin/dev/AGB/monte-carlo/monte-carlo/mc/view/MpfSimulationMultiprocess.py \
   --config ./tests/exp_aggregate_hyperspectral_callbacks_noMinMax.json -o /explore/nobackup/projects/ilab/data/AGB/test/mcruns/output/random_sets_20240208_20trials_collection-ALL_min_occurrences-100_batch_size-10_num_samples-5658_bandLen-447 \
   --bandListFile /explore/nobackup/projects/ilab/data/AGB/test/mcruns/input/random_sets/random_sets_20240208_collection-ALL_max_occurrences-100_batch_size-10_num_samples-5658_bandLen-447.pkl \
